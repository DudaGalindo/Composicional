...
#Unidades estão atualmente no SI
    def test_caso2(self):
        ...
        if caso == 2:
            ...
            T = 350 #*(9/5); - T em C originalmente - faltou ele somar 32
    ...
    def teste_table16_1(self):
        #               Met   Prop  n-Prop   n-Dec n-Hexadec
        z = np.array([0.5449,0.1394, 0.1314, 0.0869,0.0974])
        Tc = np.array([343,  666,    845 ,1112,    1291])*(9/5)
        Pc = np.array([667.2,615.8,  489.4,   305.7,205.7])
